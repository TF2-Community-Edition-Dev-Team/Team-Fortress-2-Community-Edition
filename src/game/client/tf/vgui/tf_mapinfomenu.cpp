...
#else
	m_pContinue = new CTFButton( this, "MapInfoContinue", "Continue" );
	m_pBack = new CTFButton( this, "MapInfoBack", "Back" );
	m_pIntro = new CTFButton( this, "MapInfoWatchIntro", "Watch Intro" );
#endif
...
void CTFMapInfoMenu::CheckBackContinueButtons()
{
	...
	if ( m_pBack && m_pContinue )
	{
		if ( GetLocalPlayerTeam() == TEAM_UNASSIGNED )
		{
			...
			m_pContinue->SetText( "Continue" );
		}
		else
		{
			m_pBack->SetVisible( false );
			m_pContinue->SetText( "Close" );
		}
	}
#endif
}
...
static s_MapInfo s_Maps[] = {
	{	"ctf_2fort",	"2Fort",		"Capture The Flag",		},
	{	"cp_dustbowl",	"Dustbowl",		"Attack & Defend",		},
	{	"cp_granary",	"Granary",		"Control Points",		},
	{	"cp_well",		"Well (CP)",	"Control Points",		},
	{	"cp_gravelpit", "Gravel Pit",	"Attack & Defend",		},
	{	"tc_hydro",		"Hydro",		"Territory Control",	},
	{	"ctf_well",		"Well (CTF)",	"Capture The Flag",		},
};
